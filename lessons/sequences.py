...
# An example of a tuple without type ailising
...
# Which means we can not reassign items, nor append, nor pop etc
# goat[0] = "LBJ"

# We can "invent" our own type with a type alias
player = tuple[str, int]

# Once we've aliased a type, we can create a variable of a type
